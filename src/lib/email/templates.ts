...
/**
 * Notifikasi ke Redaksi UKM Pilar Bangsa saat ada naskah baru yang disubmit.
 */
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 24px; border: 1px solid #e2e8f0; border-radius: 12px;">
          ...
          <p>Selamat! Naskah Anda yang berjudul <strong>"${params.postTitle}"</strong> telah selesai ditinjau oleh Dewan Redaksi dan kini telah tayang di Portal Media Karya Mahasiswa UNTAG Banyuwangi & UKM Pilar Bangsa.</p>
